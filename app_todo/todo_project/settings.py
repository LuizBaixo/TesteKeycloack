...
INSTALLED_APPS = ["django.contrib.admin", "django.contrib.auth", "django.contrib.contenttypes", "django.contrib.sessions", "django.contrib.messages", "django.contrib.staticfiles", "mozilla_django_oidc", "tasks"]
...
DATABASES = {"default": {"ENGINE": "django.db.backends.postgresql", "NAME": "todo", "USER": "todo", "PASSWORD": os.environ["DB_PASSWORD"], "HOST": os.environ["DB_HOST"], "PORT": "5432"}}
...
AUTHENTICATION_BACKENDS = ("todo_project.oidc_backend.KeycloakBackend", "django.contrib.auth.backends.ModelBackend")
LOGIN_URL = "oidc_authentication_init"
LOGIN_REDIRECT_URL = "/"
LOGOUT_REDIRECT_URL = "/"
OIDC_RP_CLIENT_ID = "todo"
...
OIDC_OP_LOGOUT_URL_METHOD = "todo_project.oidc.logout_url"
